...
// // Creating array for all possible arrangements of the N-Queen
...
// // setting the slider value on Slide
...
//         const currentColumn = currentRow.getElementByTagName("td")[col];
...
//             const row = table.firstChild.childNodes[i];
//             const column = row.getElementByTagName("td")[i];
...
//                 row.getElementByTagName("td")[this.position[board][k]].innerHTML = queen;
//             }
...
//                 table = document.getElementsById(`table-${this.uuid[board]}`);
...
//     if(n>8){
//         numberbox.value="";
//         alert("Queen value is too larger");
//         return;
//     }
//     else if(n<1){
//         numberbox.value="";
...
//     para.innerHTML = `For ${n}x${n} board, ${array[n]-1} arrangement are possible.`;
//     arrangement,this.appendChild(para);
